export const organization = {
    ...
    "id": "com.tuvalsoft.broker.realmmanager",
    "description": "Hook Flow Start In Organization",
    ...
    "properties": [
        {
            ...
            "choices": [
                {
                    "name": "When Account Login Successfully",
                    "value": "user_login_success"
                },
                {
                    "name": "When Account Login Fail",
                    "value": "user_login_fail"
                },
                {
                    "name": "When User Created",
                    "value": "user_created"
                },
                {
                    "name": "When Organization Created",
                    "value": "organization_created"
                },
                {
                    "name": "When Position Created",
                    "value": "position_created"
                },
