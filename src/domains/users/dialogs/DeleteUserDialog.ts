...
export class DeleteUserDialog extends DialogView {
                ...
                UIDeleteContext((deleteFunc, isLoading) =>
                    UIRecordContext(({ data }) =>
                        VStack({ alignment: cTopLeading, spacing: 10 })(
                            ...
                            Text(`Are you sure you want to delete **${data?.employee_name} ${data.employee_last_name}** ?`).renderingType(RenderingTypes.Markdown),
                    ...
                    .onSuccess(() => {
                        this.InvalidateQuerie('employees');
                        this.OnOK();
                    })
