...
import { TextAlignment, TextField, VStack, cTopLeading, useFormController, Text, HStack, cLeading } from "@tuval/forms";
...
export const TextFormView = (fieldInfo: any) => {
    ...
    const { visibleWhen, required, multiline, description, formula, defaultValue, defaultDisabled, startAdornment, endAdornment } = fieldInfo;
